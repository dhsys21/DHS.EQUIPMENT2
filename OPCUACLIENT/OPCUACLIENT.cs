...
namespace OPCUACLIENT
{
    public class OPCUACLIENT
    {
        ...
        /// </summary>
        public string OpcUaName { get; set; } = "IROCV";
        ...
        private async Task<Session> ConnectToServer2(string serverUrl)
        {
            try
            {
                // disconnect from existing session.
        ...
        public object[] CallMethod()
        {
            ...
            object[] args = null;
            CallMethodByNodeId(node_parent, nodename, args);
            //client.Session.Call()
